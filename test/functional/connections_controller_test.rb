...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { connection_time: @connection.connection_time, station_id: @connection.station_id, user_id: @connection.user_id }
    end
  ...
  test "should update connection" do
    put :update, id: @connection, connection: { connection_time: @connection.connection_time, station_id: @connection.station_id, user_id: @connection.user_id }
    assert_redirected_to connection_path(assigns(:connection))
  end
